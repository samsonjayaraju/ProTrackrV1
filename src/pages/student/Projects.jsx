                        ...
                        <form onSubmit={handleCreateProject} className="space-y-5">
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => { setNewProject(p => ({ ...p, title: e.target.value })); setFormErrors({}); }}
                            ...
                            <div>
                                ...
                                <textarea
                                    className="w-full h-24 rounded-2xl border border-border-light dark:border-border-dark bg-white dark:bg-card-dark p-4 text-sm resize-none dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select
                                        className="w-full h-12 rounded-2xl border border-border-light dark:border-border-dark bg-white dark:bg-card-dark px-4 text-sm text-text-main-light dark:text-white outline-none"
